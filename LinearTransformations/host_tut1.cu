...
int main(void)
{
    ...
    process_kernel2<<<blocksPerGrid2, threadsPerBlock2>>>(d_C, d_A, numElements);
    err = cudaGetLastError();
    ...
    process_kernel3<<<blocksPerGrid3, threadsPerBlock3>>>(d_A, d_C, numElements);
    err = cudaGetLastError();
